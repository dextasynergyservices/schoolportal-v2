...
>
    ...
    <div x-ref="wrap" class="relative">
        ...
        <input
            ...
            type="search"
            placeholder="{{ __('Search students, teachers…') }}"
            autocomplete="off"
            aria-label="{{ __('Global search') }}"
            class="w-full rounded-lg border border-zinc-200 bg-zinc-100/60 py-1.5 pl-8 pr-3 text-sm text-zinc-800 placeholder-zinc-400 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-700 dark:bg-zinc-700/50 dark:text-white dark:placeholder-zinc-500 dark:focus:border-indigo-500 dark:focus:bg-zinc-800"
        />
    </div>
