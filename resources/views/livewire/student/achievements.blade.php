    ...
    <div class="dash-panel" style="padding: 0;">
        ...
        <div class="px-4 py-3 border-t border-zinc-100 dark:border-zinc-700/50">
            <a href="{{ route('student.achievements') }}"
               class="flex items-center justify-between text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">
                <span>{{ __('View all achievements') }}</span>
