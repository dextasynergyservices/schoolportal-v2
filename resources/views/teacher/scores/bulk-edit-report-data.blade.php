<x-layouts::app :title="__('Bulk Report Data Entry')">
    <div class="space-y-6">
        ...
        {{-- Filters --}}
        <form method="GET" action="{{ route('teacher.scores.reports.bulk-edit-data') }}" class="flex flex-wrap items-end gap-4">
            <div>
        ...
        @if ($selectedClassId && $selectedTermId)
            ...
            @else
                ...
                <form method="POST" action="{{ route('teacher.scores.reports.bulk-save-data') }}">
                    @csrf
