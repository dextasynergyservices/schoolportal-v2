    ...
    <div class="space-y-6">
        ...
        <div class="max-w-2xl">
            <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 p-6">
                <form method="POST" action="{{ route('teacher.assignments.update', $assignment) }}" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <flux:input name="file_url" :label="__('Link to File (optional)')" type="url" :value="old('file_url', $assignment->getRawOriginal('file_url'))" placeholder="https://example.com/assignment.pdf" />
