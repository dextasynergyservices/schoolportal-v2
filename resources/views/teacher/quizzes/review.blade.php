                        ...
                        <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 p-4 mb-4">
                            ...
                            <div class="space-y-3">
                                <textarea :name="'questions[' + qIndex + '][question_text]'" x-model="question.question_text" rows="2"
                                    class="w-full rounded-lg border border-zinc-200 border-b-zinc-300/80 dark:border-white/10 bg-white dark:bg-white/10 shadow-xs px-3 py-2 text-sm text-zinc-700 dark:text-zinc-300" required></textarea>
