...
@media print {
    ...
    flux-button, [wire\:navigate][href*="back"],
    [href*="report-cards"]:not([href*="show"]) {
    ...
    /* Report card container fills the page */
    .space-y-6 > div:first-child { display: none !important; } /* Hide the back/download bar */
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between flex-wrap gap-3">
            <div>
                ...
                <h1 class="text-xl font-bold text-zinc-900 dark:text-white">{{ __('My Report Card') }}</h1>
        ...
        <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden shadow-sm">
            ...
            {{-- Grading Key --}}
            @php $gradingItems = $report->resolvedGradingItems($gradingScale); @endphp
