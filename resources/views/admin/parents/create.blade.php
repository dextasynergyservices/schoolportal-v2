            ...
            <form method="POST" action="{{ route('admin.parents.store') }}" class="space-y-6">
                ...
                <fieldset
                    x-data="{
                        ...
                        selectedLevelIds: [],
                        selectedClassIds: [],
                        selectedStudentIds: {{ Js::from(old('student_ids', [])) }},
                        search: '',
                ...
                >
                    <legend class="text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-3">{{ __('Link to Students') }} <span class="text-red-500">*</span></legend>
