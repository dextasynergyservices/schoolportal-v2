<x-layouts.error :title="__('Access Denied')">
    <div class="text-6xl font-bold text-amber-500">403</div>
    <h1 class="text-xl font-semibold text-zinc-800 dark:text-zinc-200">{{ __('Access denied') }}</h1>
    <p class="text-zinc-500 dark:text-zinc-400">{{ __('You do not have permission to access this page.') }}</p>
